...
if __name__ == "__main__":
    ...
    # prompt type can be: ["default", "persona_aware", "persona_aware_regsubj", "longer_responses", "persona_age_awareXX", "persona_grade_awareXX", "linguistically_aware_general", "linguistically_aware_specific"]   # XX refers to the age/grade of the speaker
